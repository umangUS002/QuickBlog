    ...
    <div className='mx-8 sm:mx-16 xl:mx-24 relative'>
      <div className='text-center mt-20 mb-8'>
        ...
        <div className='inline-flex items-center justify-center gap-4 px-6 py-1.5 mb-4 border-primary/40 bg-primary/10 rounded-full text-sm text-primary'>
            ...
            <img src={assets.star_icon} className='w' alt='' />
        </div>
        ...
        <div className='text-center'>
          {input && <button onClick={onClear} className='border font-light text-xs mt-10 py-1 px-3 rounded-sm shadow-custom-sm cursor-pointer'>Clear Search</button>}
        </div>
